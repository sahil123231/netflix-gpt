      ...
      createUserWithEmailAndPassword(
        ...
        .then((userCredential) => {
          ...
          updateProfile(user, {
            ...
            photoURL:
              "https://lh3.google.com/u/0/ogw/ANLem4Y6F0BC2BpStWqpvRnSgOkK3TvD8ovjqrZ0fp0t=s32-c-mo",
          })
            .then(() => {
